# * Try to find Google performance tools (gperftools) Input variables:
#   GPERFTOOLS_ROOT_DIR    - The gperftools install directory; if not set the
#   GPERFTOOLS_DIR environment variable will be used GPERFTOOLS_INCLUDE_DIR -
#   The gperftools include directory GPERFTOOLS_LIBRARY     - The gperftools
#   library directory Components: profiler, and tcmalloc or tcmalloc_minimal
#   Output variables: GPERFTOOLS_FOUND        - System has gperftools
...
if(NOT DEFINED GPERFTOOLS_FOUND)
  ...
  foreach(_comp ${Gperftools_FIND_COMPONENTS})
    if((NOT _comp STREQUAL "tcmalloc_and_profiler")
       AND (NOT _comp STREQUAL "tcmalloc")
       AND (NOT _comp STREQUAL "tcmalloc_minimal")
       AND (NOT _comp STREQUAL "profiler"))
      message(
        FATAL_ERROR "Invalid component specified for Gperftools: ${_comp}")
    endif()
  endforeach()
